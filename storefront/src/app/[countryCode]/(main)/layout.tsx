...
export default async function PageLayout(props: { children: React.ReactNode }) {
  ...
  return (
    <>
      <NavigationHeader />
      <div className="flex items-center text-foreground justify-center small:p-4 p-2 text-center bg-secondary small:gap-2 gap-1 text-sm border-b border-border">
