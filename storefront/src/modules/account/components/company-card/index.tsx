      ...
      <Container className="p-0 overflow-hidden">
        ...
        >
          <div className="flex flex-col gap-y-2">
            <Text className="font-medium text-foreground">Company Name</Text>
            <Input
              label="Company Name"
              name="name"
          ...
          <div className="flex flex-col gap-y-2">
            <Text className="font-medium text-foreground">Address</Text>
            <Input
              label="Address"
              name="address"
          ...
          <div className="flex flex-col gap-y-2">
            <Text className="font-medium text-foreground">City</Text>
            <Input
              label="City"
              name="city"
          ...
          <div className="flex flex-col gap-y-2">
            <Text className="font-medium text-foreground">State</Text>
            <Input
              label="State"
              name="state"
          ...
          <div className="flex flex-col gap-y-2">
            <Text className="font-medium text-foreground">Zip</Text>
            <Input
              label="Zip"
              name="zip"
          ...
          <div className="flex flex-col gap-y-2">
            <Text className="font-medium text-foreground">Country</Text>
            <Select
              name="country"
